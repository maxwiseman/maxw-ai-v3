// Types from DMontgomery40/mcp-canvas-lms
// https://github.com/DMontgomery40/mcp-canvas-lms/blob/main/src/types.ts

/** biome-ignore-all lint/suspicious/noExplicitAny: Some types are difficult to fully define, and not really relavent */
...
export interface CanvasCourse {
  ...
  readonly teachers?: CanvasCourseTeacher[];
}
...
export interface CanvasDiscussionPermissions {
  attach: boolean;
  update: boolean;
  reply: boolean;
  delete: boolean;
...
export interface CanvasDiscussion {
  ...
  discussion_subentry_count: number;
  permissions: CanvasDiscussionPermissions;
