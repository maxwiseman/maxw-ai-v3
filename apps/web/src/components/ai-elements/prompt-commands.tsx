            ...
            {commands.pills.length > 0 &&
              commands.pills.map((pill) => (
                <div
                  ...
                  className="mt-2.5 ml-2 inline-flex items-center bg-accent px-1.5 py-0.5 text-accent-foreground text-sm"
                >
...
function PromptCommandsPaletteContent() {
  ...
  return (
    <PopoverContent
      className="max-h-[300px] w-[var(--radix-popover-trigger-width)] overflow-y-auto rounded-none p-0"
      align="center"
      side="bottom"
      alignOffset={0}
      sideOffset={55}
            ...
            {filteredAgents.map((agent, index) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full cursor-pointer px-2 py-2 text-left",
